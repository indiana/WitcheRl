...
public class StandardMoveAndAttack : IBehavior
{
  public bool Act( Monster monster, CommandSystem commandSystem )
  {
    ...
    if ( !monster.TurnsAlerted.HasValue )
    {
      ...
      {
        Game.MessageLog.Add( $"{monster.Name} zamierza zaatakowac {player.Name}" );
    ...
    if ( monster.TurnsAlerted.HasValue )
    {
      ...
      catch ( PathNotFoundException )
      {
        ...
        Game.MessageLog.Add( $"{monster.Name} nie moze znalezc drogi" );
      }
      ...
      if ( path != null )
      {
        ...
        {
          Game.MessageLog.Add( $"{monster.Name} wyje z wscieklosci" );
        }
      }
